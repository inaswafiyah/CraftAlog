...
<body>
    ...
    <div class="container text-center my-5">
        <div class="title-wrapper piacantik">
            <p class="text-uppercase color-pink">DIY Projects</p>
            <h1 class="title">Various kinds of</h1>
            <h1 class="title">handicraft Tutorials.</h1>
...
<div class="search-container searchlucuk">
  ...
  <div class="container footer">
    <div class="row">
      ...
      <a href="https://www.instagram.com/belajar_masak_harian?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="social-icon"><i class="fab fa-instagram"></i></a>
      <a href="https://t.me/dapoerummai" class="social-icon"><i class="fab fa-telegram"></i></a>
      <a href="https://www.tiktok.com/@dapoer.ummai?is_from_webapp=1&sender_device=pc" class="social-icon"><i class="fab fa-tiktok"></i></a>
      <a href="https://www.youtube.com/@dapoerummai9351" class="social-icon"><i class="fab fa-youtube"></i></a>
            </div>
        </div>
        <div class="col-md-2">
            <div>CALL US</div>
